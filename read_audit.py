...
if __name__ == '__main__':
    ...
    display('Computing audit file', verbose=True)
    structure = write_audit(audit)
    display('Writing down audit file', verbose=True)
